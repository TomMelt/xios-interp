...
void cxios_set_domain_name(xios::CDomain* domain_hdl, const char* name, int name_size);
void cxios_get_domain_name(xios::CDomain* domain_hdl, char* name, int name_size);
bool cxios_is_defined_domain_name(xios::CDomain* domain_hdl);
